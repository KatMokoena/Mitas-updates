...
/**
 * Entity for project ownership transfer invitations
 * Similar to TaskInvitation but for project ownership transfers
 */
@Entity('project_ownership_invitations')
export class ProjectOwnershipInvitationEntity {
  @PrimaryColumn('uuid')
  id!: string;
